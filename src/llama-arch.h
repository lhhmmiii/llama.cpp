...
enum llm_tensor {
    ...
    LLM_TENSOR_ATTN_Q_ADAPTER_A,
    LLM_TENSOR_ATTN_K_ADAPTER_A,
    LLM_TENSOR_ATTN_V_ADAPTER_A,
    LLM_TENSOR_ATTN_Q_ADAPTER_B,
    LLM_TENSOR_ATTN_K_ADAPTER_B,
    LLM_TENSOR_ATTN_V_ADAPTER_B,
    ...
    LLM_TENSOR_FFN_DOWN,
    LLM_TENSOR_FFN_UP,
    LLM_TENSOR_FFN_ADAPTER_A,
    LLM_TENSOR_FFN_ADAPTER_B,
    LLM_TENSOR_FFN_ACT,
