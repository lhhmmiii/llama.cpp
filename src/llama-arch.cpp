...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_ATTN_Q_ADAPTER_A,                       "blk.%d.attn_q_adapter_a" },
    { LLM_TENSOR_ATTN_K_ADAPTER_A,                       "blk.%d.attn_k_adapter_a" },
    { LLM_TENSOR_ATTN_V_ADAPTER_A,                       "blk.%d.attn_v_adapter_a" },
    { LLM_TENSOR_ATTN_Q_ADAPTER_B,                       "blk.%d.attn_q_adapter_b" },
    { LLM_TENSOR_ATTN_K_ADAPTER_B,                       "blk.%d.attn_k_adapter_b" },
    { LLM_TENSOR_ATTN_V_ADAPTER_B,                       "blk.%d.attn_v_adapter_b" },
    { LLM_TENSOR_FFN_GATE_INP,                           "blk.%d.ffn_gate_inp" },
    { LLM_TENSOR_FFN_NORM,                               "blk.%d.ffn_norm" },
    { LLM_TENSOR_FFN_GATE,                               "blk.%d.ffn_gate" },
    { LLM_TENSOR_FFN_DOWN,                               "blk.%d.ffn_down" },
    { LLM_TENSOR_FFN_UP,                                 "blk.%d.ffn_up" },
    { LLM_TENSOR_FFN_ADAPTER_A,                          "blk.%d.ffn_adapter_a" },
    { LLM_TENSOR_FFN_ADAPTER_B,                          "blk.%d.ffn_adapter_b" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_ATTN_Q_ADAPTER_A,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_Q_ADAPTER_B,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_K_ADAPTER_A,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_K_ADAPTER_B,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_V_ADAPTER_A,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_V_ADAPTER_B,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_GATE,                  {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_GATE,                   {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_DOWN,                   {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_UP,                     {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_ADAPTER_A,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_ADAPTER_B,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
